                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="room.php" class="nav-item nav-link active">Phòng hát</a>
                            <!-- NHAN VIEN -->
                            <?php
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    ?>
                                    <a href="review.php" class="dropdown-item">Báo cáo thống kê</a>
                                    <a href="booking.php" class="dropdown-item">Quản lý nhân viên</a>
...
// BANNER ADS
include("template/_room_banner.php");


// All room
include("template/_all_room_2.php");

// include("template/_all_room.php");
