                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="admin_order.php" class="dropdown-item active">Quản lý hóa đơn</a>
...
<h1 class="title font-alt text-center wow flipInX">placed orders</h1>

<section class="placed-orders wow fadeInUp" data-wow-delay="0.1s">
      ...
      <div class="box">
        <p> User id : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         <p> Đặt vào : <span><?php echo $fetch_orders['place_on']; ?></span> </p>
         ...
         <p> Phòng đã đặt : <span><?php echo $fetch_orders['total_product']; ?></span> </p>
         <p> Tổng chi phí : <span><?php echo $fetch_orders['total_price']; ?>K</span> </p>
         ...
         <form action="" method="post">
            ...
            <input type="submit" value="update" name="update_order" class="btn btn-sm btn-primary rounded py-2 px-4 font-alt bg-primary">
            <a href="admin_order.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('delete this order?');" class="btn btn-sm btn-primary rounded py-2 px-4 font-alt bg-danger">delete</a>
         </form> 
      ...
      <?php
        ...
        echo '<br>';
         echo '<h1 class="text-danger text-center font-alt">no orders placed yet!</h1>';
        echo '<br>';
