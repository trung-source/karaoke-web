                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="admin_room.php" class="dropdown-item">Quản lý hóa đơn</a>

                                    <!-- ADMIN -->
                                    <?php
                                    if(isset($user_id) && $user_type == "admin"){
                                    ?>
                                    <a href="template/_admin_room.php" class="dropdown-item">Báo cáo thống kê</a>
                                    <a href="template/_admin_room.php" class="dropdown-item">Quản lý nhân viên</a>
