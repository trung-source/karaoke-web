<section class="show-rooms wow fadeInUp">
   <div>
      ...
      <?php
         $select_products = mysqli_query($db->con, "SELECT * FROM `room` WHERE room_type = 'vip'") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            
      ?>
         <section id="phong-vip">
            <div class="container py-5 wow fadeInUp" data-wow-delay="0.5s">
                <h4 class="font-alt font-size-20">Phòng Vip</h4>
                <hr>
                <!-- owl carousel -->
         ...
         echo '<h3 class="font-alt text-center text-danger py-5">no vip room added yet!</h3>';
      }
      ?>
   </div>
