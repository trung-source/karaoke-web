                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    ?>
                                    <a href="admin_page.php" class="dropdown-item active">Báo cáo thống kê</a>
...
<section class="dashboard wow flipInX">
        <br>
   <h1 class="title font-alt">dashboard</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         ?>
         <h3><?php echo $total_pendings; ?>K</h3>
      ...
      <div class="box">
         ...
         ?>
         <h3><?php echo $total_completed; ?>K</h3>
      ...
      <div class="box">
         <?php 
            $select_admins = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'nhanvien'") or die('query failed');
...
<section id="Search" class="search-form wow fadeInUp" data-wow-delay="0.2s">
...
<section class="products" data-wow-delay="0.2s" style="padding-top: 0;">
<br>
   <?php
   ...
   <form action="" method="post" class="box wow fadeInUp">
      <img src="assets/product/<?php echo $fetch_product['type'].'/'; echo $fetch_product['image']; ?> ?>" alt="" class="image">


      <div class="price"><?php echo $fetch_product['price']; ?>K/1</div>

      <div class="name">Tên: <?php echo $fetch_product['name']; ?></div>
      <div class="name">Số lượng: <?php echo $fetch_product['amount']; ?></div>
      <div class="name">Tổng tiền: <?php 
      $total_product += $fetch_product['amount']*$fetch_product['price'];
      echo $fetch_product['amount']*$fetch_product['price']; ?>K</div>
...
<br>
   <?php
            ...
            ?>
<div class="box">
<div class="name wow fadeInUp">Tổng tiền toàn bộ sản phẩm: <?php echo $total_product; ?>K</div>
</div>
