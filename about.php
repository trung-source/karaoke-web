...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0 wow fadeIn" style="background-image: url(assets/1.jpg);">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow slideInLeft">
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Karaoke</span></h1>
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2 font-baloo" href="">TÌM HIỂU THÊM</a>
                </div>
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="assets/decorate/about-1.jpg" style="margin-top: 25%;">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="assets/decorate/about-2.jpg">
                        </div>
                        <div class="col-6 text-end">
                            <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="assets/decorate/about-3.jpg">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="assets/decorate/about-4.jpg">
                        </div>
                    </div>
                </div>
            </div>
