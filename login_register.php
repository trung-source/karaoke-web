                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="login_register.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        ...
                        <a href="<?php echo "login_register.php" ?>" class="font-alt btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Login Now <i class="fa fa-arrow-right ms-3"></i></a>
                    </div>
                </nav>
            </div>
        </div>
